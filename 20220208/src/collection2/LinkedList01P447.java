...
import java.util.ArrayList; // List 인터페이스로 구현
import java.util.LinkedList; // List 인터페이스로 구현
...
public class LinkedList01P447 {
	...
	public static void main(String[] args) {
		...
		// ArrayList에서 쓸 수 있는 메소드는 LinkedList에서 쓸 수 있고
		// LinkedList는 ArrayList에서 쓸 수 있다.
		...
		// list1.remove("스프링"); // "스프링" 자료형을 번호와 상관없이 삭제합니다.
		// System.out.println(list1);
